    ...
    public partial class carCtrl : Form
    {
        ...
        private void buyBtn_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cIDCheckCMD = new SqlCommand(cIDCheckQuery, redundantData.con);
                ...
                else //if it is valid then validating manufacturer
                {
                    ...
                    SqlCommand mIDCheckCMD = new SqlCommand(mIDCheckQuery, redundantData.con);
                    ...
                    if (mIDCheckSet.Tables[0].Rows.Count > 0)
                    {
                        ...
                        redundantData.con.Open();     //if manufacturer id is repeated then checking name
                    ...
                    if (isnewSeller)
                    {
                        ...
                        if (mEmailCheckSet.Tables[0].Rows.Count == 0)
                        {
                            ...
                            SqlCommand manufAddCMD = new SqlCommand(manufAddQuery, redundantData.con);
                    ...
                    if (isOldSeller || isnewSeller)
                    {
                        ...
                        SqlCommand addOrderCMD = new SqlCommand(addOrderQuery, redundantData.con);
                        ...
                        SqlCommand addBillCMD = new SqlCommand(addBill, redundantData.con);
                        ...
                        SqlCommand addStockCMD = new SqlCommand(addStock, redundantData.con);
